...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalFormtransaksi" style="margin-top: 2px;">
                Tambah transaksi!
            </button>
...
<script>
    ...
    $(function() {
        $('#tbl-transaksi').DataTable(); // Corrected the DataTable initialization
    });
    ...
    $('#modalFormtransaksi').on('show.bs.modal', function(e) {
        ...
        const nama_transaksi = btn.data('nama_transaksi');
        const id = btn.data('id');
        const modal = $(this);
        if (mode === 'edit') {
            modal.find('.modal-title').text('Edit Data transaksi');
            modal.find('#Nama').val(nama_transaksi); // Assuming your input field has the id "Nama"
